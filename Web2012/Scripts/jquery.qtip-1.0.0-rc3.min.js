         ...
         f(window).bind("resize scroll", function (t) {
             ...
             s = setTimeout(function () {
                 ...
                 for (i = 0; i < f.fn.qtip.interfaces.length; i++) {
                     ...
                     if (u!=undefined && u.status.rendered === true && (u.options.position.type !== "static" || u.options.position.adjust.scroll && t.type === "scroll" || u.options.position.adjust.resize && t.type === "resize")) {
